...
@EntityRegister(businessType = StringManager._3)
public class Test1Entity extends BasicsEntity {

	public Test1Entity(byte messageType, byte businessType, long messageNumber,
			int bodyLength, byte[] body) {
		super(messageType, businessType, messageNumber, bodyLength, body);
		System.out.println("========Test1Entity");
	}
